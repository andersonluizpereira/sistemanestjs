...
export class PetController {
    ...
    async createPet(@Param('document') document, @Body() model: Pet) {
        try {
            ...
            throw new HttpException(new Result('Não foi possível criar o seu pet',false, null, error), HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async updatePet(@Param('document') document,@Param('id') id, @Body() model: Pet) {
        try {
            ...
            throw new HttpException(new Result('Não foi possível atualizar o seu pet',false, null, error), HttpStatus.BAD_REQUEST);
        }
    }
}